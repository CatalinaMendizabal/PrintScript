...
val token_014 = listOf(
    ...
    Token(TokenTypes.TYPESTRING, 14, 20, LexicalRange(14, 0, 20, 0)),
    Token(TokenTypes.EQUAL, 21, 22, LexicalRange(21, 0, 22, 0)),
    Token(TokenTypes.READINPUT, 23, 32, LexicalRange(23, 0, 32, 0)),
    Token(TokenTypes.LEFTPARENTHESIS, 32, 33, LexicalRange(32, 0, 33, 0)),
    Token(TokenTypes.STRING, 33, 39, LexicalRange(33, 0, 39, 0)),
    Token(TokenTypes.SUM, 40, 41, LexicalRange(40, 0, 41, 0)),
    Token(TokenTypes.READINPUT, 42, 51, LexicalRange(42, 0, 51, 0)),
    Token(TokenTypes.LEFTPARENTHESIS, 51, 52, LexicalRange(51, 0, 52, 0)),
    Token(TokenTypes.STRING, 52, 60, LexicalRange(52, 0, 60, 0)),
    Token(TokenTypes.RIGHTPARENTHESIS, 60, 61, LexicalRange(60, 0, 61, 0)),
    Token(TokenTypes.SUM, 62, 63, LexicalRange(62, 0, 63, 0)),
    Token(TokenTypes.STRING, 64, 67, LexicalRange(64, 0, 67, 0)),
    Token(TokenTypes.RIGHTPARENTHESIS, 67, 68, LexicalRange(67, 0, 68, 0)),
    Token(TokenTypes.SEMICOLON, 68, 69, LexicalRange(68, 0, 69, 0)),
    Token(TokenTypes.EOF, 69, 69, LexicalRange(69, 0, 69, 0))
)
